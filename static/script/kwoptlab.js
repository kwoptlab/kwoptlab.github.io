    ...
    $.getJSON(path, (data) => {
      $.each(data, (key, value) => {
        ...
        html +=
          ...
          value.body.length +
          textNumber +
          '</div>\n</div>\n<div class="ui bottom attached button" onclick="readMorePublication(\'' +
          key +
          '\');"><i class="teal add icon"></i>\n' +
          textButton +
          "</div>\n</div>";
  ...
  function initProjects(lang) {
    ...
    $.getJSON(path, (data) => {
      ...
      for (var i = 0; i < data.length; ++i) {
        html +=
          '<div class="item" style="padding-bottom: 0.5em; padding-top: 0.5em;">\n<i class="teal folder icon" ></i>\n<div class="content">' +
          data[i] +
          "</div>\n</div >";
      }
          ...
          for (k = 0; k < lectures.length; ++k) {
            ...
            for (l = 0; l < comments.length; ++l) {
              html +=
                ...
                comments[l] +
                '\');"><i class="teal medium comment alternate outline icon"></i></a>\n';
            }
